...
const VERSION='2026.08.20.7',OWNER='pvtkyron',REPO='pantry-core',cdn='https://cdn.jsdelivr.net/gh/'+OWNER+'/'+REPO+'@main/assets/blogfa-editorial.css?rev='+VERSION,api='https://api.github.com/repos/'+OWNER+'/'+REPO+'/contents/assets/blogfa-editorial.css?ref=main';
